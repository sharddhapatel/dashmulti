...
<!-- Mirrored from www.bootstrapdash.com/demo/plus/jquery/template/demo_1/pages/samples/register-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Mar 2022 06:02:39 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
            ...
            <div class="col-lg-12 d-flex align-items-center justify-content-center">
              <div class="auth-form-transparent text-left p-3">
                ...
                <form class="pt-3">
                  ...
                  <div class="mt-3">
                    <a class="btn btn-block btn-primary btn-lg font-weight-semibold auth-form-btn" href="{{url('super-register')}}">SIGN UP</a>
                  </div>
                  <div class="text-center mt-4 font-weight-light"> Already have an account? <a href="{{url('super-login')}}" class="text-primary">Login</a>
                  </div>
                </form>
              </div>
            </div>
